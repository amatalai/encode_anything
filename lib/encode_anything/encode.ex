defmodule EncodeAnything.EncodeError do
...
defmodule EncodeAnything.Encode do
  @moduledoc """
  ...
  alias EncodeAnything.Codegen
  alias EncodeAnything.EncodeError
  alias EncodeAnything.Encoder
  alias EncodeAnything.Fragment
  ...
  def encode(value, opts) do
    ...
    try do
      ...
      :error, %Protocol.UndefinedError{protocol: EncodeAnything.Encoder} = e ->
        {:error, e}
    end
  end
  ...
  @doc """
  Equivalent to calling the `EncodeAnything.Encoder.encode/2` protocol function.
